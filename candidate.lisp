...
(hunchentoot:define-easy-handler (mick :uri "/michaelmcnamara")
    ()
  (destructuring-bind (number . caption) (get-suit)
    (with-standard-page (:title "Michael McNamara - Candidate for the European elections")
      (htm  ((:div :class "candidate-display")
	     ...
	     ((:div :class "span-12 last")
		  ...
		  (:hr :class "space")
		  "Articles by Michael McNamara on this site: "
...
(defvar *suits*
  '((1 . "Michael with Aitzaz Ahsan, Leader of the Lawyers' Movement in Pakistan February 2008")
    (2 . "Michael with the Chief Justice of Yemen")))
